 ...
 *
 * Manages Twig Environment configuration and template rendering for App namespace.
...
final readonly class TwigService
{
     ...
     *
     * @param string $template Template path relative to template directory (e.g., 'app/welcome.html.twig')
