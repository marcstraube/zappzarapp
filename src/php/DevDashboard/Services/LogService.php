    ...
    public function getAvailableLogSources(): array
    {
        $sources = [
            ...
            'elasticsearch' => [
                ...
                'command'     => 'make logs-elasticsearch',
            ],
            'mailpit' => [
                'name'        => 'Mailpit Logs',
    ...
    public function getLogCommands(): array
    {
        return [
            ...
            [
                ...
                'command'     => 'make logs php',
                'description' => 'Or use: make logs-php, make logs-nginx, make logs-node',
            ],
            [
                'label'       => 'View Multiple Services',
                'command'     => 'make logs php nginx',
                'description' => 'View logs from multiple services at once',
            ],
            [
                'label'       => 'Save Logs to File',
                'command'     => 'make logs-save SERVICES=php,nginx',
                'description' => 'Export logs to timestamped directory',
            ],
            [
                'label'       => 'Search Logs',
                'command'     => 'make logs | grep "error"',
